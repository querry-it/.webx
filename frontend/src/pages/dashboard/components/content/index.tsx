...
export default function Content() {
  useEffect(() => {
    ...
    const terrain = L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}", { maxZoom: 19 });

    L.control.layers({ Streets: streets, Satellite: satellite, Terrain: terrain }).addTo(map);

    // Ranh giới Hà Nội
    L.geoJSON(hanoiBoundaryGeoJSON, {
      style: { color: "#FF0000", weight: 3, fillColor: "#FFAAAA", fillOpacity: 0.2 },
    ...
    // Search box
    L.Control.geocoder({ defaultMarkGeocode: true, placeholder: "Tìm địa điểm..." }).addTo(map);
