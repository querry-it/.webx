...
//   active: boolean,
//   dispatch: any,
//   getClearQuery: () => boolean,
// ) {
//   useEffect(() => {
//     const map = mapRef.current;
//     if (!map) return;
//     toggleMarkerLayer(map, category, active, dispatch, getClearQuery);
//     return () => {
//       toggleMarkerLayer(map, category, false, dispatch, getClearQuery);
//     };
//   }, [active]);
// }
...
//   const getClearQuery = useCallback(
