...
import List from "./components/location__add/components/List";
import Label from "./components/location__add/components/Label";
    ...
    <div className={cx("content")}>
      ...
      {true && (
        <div className={cx("location__add")}>
          <div className="w-[372px] h-screen relative right-[372px] bg-white flex flex-col">
            <div className="flex items-end w-full h-[130px] shrink-0 shadow-[0_2px_4px_-1px_rgba(0,0,0,0.4)]">
              <button onClick={() => setActiveTab("list")} className="mx-auto hover:bg-gray-200 h-[48px] p-4">
                <div className="relative w-fit">
                  <div className="whitespace-nowrap text-gray-500 font-semibold text-[14px]">
                    Danh sách
                  </div>
                  <div className="bg-teal-600 h-[3px] absolute top-[30px] left-0 right-0 rounded-t-[3px]" />
                </div>
              </button>

              <button onClick={() => setActiveTab("label")} className="mx-auto hover:bg-gray-200 h-[48px] p-4">
                <div className="relative w-fit">
                  <div className="whitespace-nowrap text-gray-500 font-semibold text-[14px]">
                    Đã gắn nhãn
                  </div>
