...
export default function RatingFeedback({ feedbacks }) {
  const ratingEntries = Object.entries(feedbacks.ratingStar);
    ...
    <div className={cx('rating__grid')}>
      <div className={cx('rating-fill__wrapper')}>
        <div className={cx('rating-fill__grid')}>
          {ratingEntries
            ...
            .map(([star, count]) => {
              ...
              return (
                <div className={cx('rating__items')}>
        ...
        <div className={cx('rating-overview__wrapper')}>
          <div className={cx('rating-medium')}>{feedbacks.rating}</div>
          ...
          <div className={cx('rating-count')}>{feedbacks.reviews} bài viết</div>
        </div>
      </div>
