                    ...
                    <div className="w-[372px] h-screen relative bg-white flex flex-col">
                        <div className="flex items-end w-full h-[130px] shrink-0 shadow-[0_2px_4px_-1px_rgba(0,0,0,0.4)]">
                            <button
                                ...
                                className={`${activeTab === "list" ? "hover:bg-blue-100" : ""} mx-auto hover:bg-gray-200 h-[48px] p-4`}
                            >
                                <div className={` relative w-fit`}>
                                    <div
                                        className={`${activeTab === "list" ? "text-teal-600" : ""} whitespace-nowrap text-gray-500 font-semibold text-[14px]`}
                                    >
                                        Danh sách
                                    </div>
                                    <div
                                        className={`${activeTab === "list" ? "bg-teal-600" : "hidden"} h-[3px] absolute top-[30px] left-0 right-0 rounded-t-[3px]`}
                                    />
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                className={`${activeTab == "label" ? "hover:bg-blue-100" : ""} mx-auto hover:bg-gray-200 h-[48px] p-4`}
                            >
                                <div className="relative w-fit">
                                    <div
                                        className={`${activeTab === "label" ? "text-teal-600" : ""} whitespace-nowrap text-gray-500 font-semibold text-[14px]`}
                                    >
                                        Đã gắn nhãn
                                    </div>
                                    <div
                                        className={`${activeTab === "label" ? "bg-teal-600" : "hidden"}  h-[3px] absolute top-[30px] left-0 right-0 rounded-t-[3px]`}
                                    />
                                </div>
                            </button>
                        </div>
