      ...
      <>
        <div className={cx('save__footer')}>
          <div
            className={cx('item')}
            onClick={() => {
              setState('SET_NAVBAR_X', 'option', 'home');
            }}
          >
            <div className={cx('header')}>
              <House size={Icon.current.x} strokeWidth={Icon.current.y} />
            </div>
          ...
          <div
            className={cx('item')}
            onClick={() => {
              setState('SET_NAVBAR_X', 'option', 'work');
            }}
          >
            <div className={cx('header')}>
              <BriefcaseBusiness
      ...
      <>
        <div className={cx('save__footer')}>
          <div
            ...
            onClick={() => {
              if (state.navbar_x.save !== 'add' && !state.navbar_x.back) {
          ...
          >
            <span>
              <Plus size={Icon.current.x} strokeWidth={Icon.current.y} />
            </span>
          ...
          {list.map((value, index) => {
            ...
            return (
              ...
              >
                <div className={cx('header')}>
                  {Logo && (
                    <Logo size={Icon.current.x} strokeWidth={Icon.current.y} />
                  )}
                </div>
                <div className={cx('content')}>
                  <span className={cx('title')}>{value.name}</span>
                  <span className={cx('content')}>
        ...
        <div className={cx('name__add')}>
          <div className={cx('name__content')}>
            <div className={cx('content__input')}>
              <input type="text" placeholder="Danh sách không có tiêu đề" />
            </div>
          </div>
        ...
        <div className={cx('input__add')}>
          <div className={cx('input__content')}>
            <div className={cx('icon__left')}>
              <Search size={Icon.current.x} strokeWidth={Icon.current.y} />
            </div>
            <div className={cx('content')}>
              <input
                type="text"
            ...
            <div className={cx('suggestions')}>
              {filteredSuggestions.length > 0 ? (
                filteredSuggestions.map((item, index) => (
                  ...
                  >
                    <MapPin className={cx('icon')} size={18} />
    ...
    return (
      <div className={cx('save__bgr')}>
        ...
        <div className={cx('save__content')}>
          ...
          >
            <span className={cx('content__title')}>Đã gắn nhãn</span>
            <span className={cx('content__active')}></span>
          </div>
        </div>
