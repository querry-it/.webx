...
export default function HistoryComponent() {
    ...
    const last3Days = items.filter((item) =>
        isWithinLast3Days(item.searchedAt),
    );
                                    ...
                                    {last3Days.map((place) => (
                                        ...
                                        >
                                            ...
                                            <div className={cx("place-items")}>
                                                ...
                                                <div
                                                    className={cx("place-type")}
                                                >
                                                    {place.type}
                                                </div>
                                                <div
                                                    className={cx("place-save")}
                                                >
                                                    ...
                                                    >
                                                        Da luu vao abc va danh
                                                        sach cac tieu de chua co
                                                        ten
                                                    </span>
                                                </div>
                                            </div>
