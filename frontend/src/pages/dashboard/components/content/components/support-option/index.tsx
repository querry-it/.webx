...
//   const [checkedClass, setCheckedClass] = useState({ 1: true });
//   const [checkedMarker, setCheckedMarker] = useState({});
//   const [checkedTravel, setCheckedTravel] = useState({});

//   const toggleChecked = (group, id) => {
//     if (group === 'class') {
//       setCheckedClass((prev) => ({ ...prev, [id]: !prev[id] }));
//     }
//     if (group === 'marker') {
//       setCheckedMarker((prev) => ({ ...prev, [id]: !prev[id] }));
//     }
//     if (group === 'travel') {
//       setCheckedTravel((prev) => ({ ...prev, [id]: !prev[id] }));
//     }
//   };
...
export default function SupportComponent() {
  ...
  // Hàm toggle có lưu localStorage
  const toggleChecked = (group, id) => {
    if (group === 'class') {
