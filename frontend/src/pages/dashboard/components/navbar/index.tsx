...
export default function Navbar() {
  ...
  const { getFullName, getAvatar } = UserHook();
        ...
        <div className={cx('header')}>
          <div className={cx('header__start')}>
            <div
              ...
              onClick={() => {
                setState('SET_NAVBAR_X', 'activeX', 'introducer');
            ...
            >
              <button
                className={cx({
                  active: state.navbar_x.activeX === 'introducer',
                })}
              >
                <Earth
          ...
          <div className={cx('header__end')}>
            ...
            >
              <button
                className={cx({
                  active: state.navbar_x.activeX === 'history',
                })}
              >
                <History
                  size={Icon.current.size}
            ...
            <div
              ...
              onClick={() => {
                setState('SET_NAVBAR_X', 'dynamic', !state.navbar_x.dynamic);
              }}
            ...
            <div
              ...
              onClick={() => {
                ...
                if (state.navbar_x.activeX !== 'account') {
                  setState('SET_NAVBAR_X', 'activeX', 'account');
                }
              }}
