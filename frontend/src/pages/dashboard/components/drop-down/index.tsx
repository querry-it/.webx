...
export default function DropDown() {
  ...
  const { getFullName, getUserName, getAvatar } = UserHook();
          ...
          <div className={cx('wrapper__top')}>
            {getAvatar() === null ? (
              <div className={cx('avatar')}>
                <p className={cx('name')}>{getAvatarLetters(getFullName())}</p>
              </div>
            ) : (
            ...
            <div className={cx('info')}>
              <p className={cx('title')}>{getFullName()}</p>
              <p className={cx('code')}>{`@${getUserName()}`}</p>
            </div>
          </div>
        </button>
      </div>
