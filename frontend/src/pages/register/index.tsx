        ...
        <div className="flex flex-col items-center justify-center my-10 px-20">
          <form onSubmit={handleSubmit} className="w-full">
            ...
            <div className="mb-8">
              ...
              >
                ...
                <button
                  ...
                  onClick={() => setActivePassword((prev) => !prev)}
                >
                  {activePassword ? (
            ...
            <div>
              ...
              >
                ...
                <input
                  ...
                  type={activeConfirmPassword ? 'text' : 'password'}
                  className="mx-[44px] w-full h-full outline-none border-none text-[16px] focus:ml-[18px]"
                  placeholder={activeUser.confirm ? '' : 'Nhập lại mật khẩu...'}
                  value={user.confirm}
                  onChange={(e) =>
                    setUser((prev) => ({
                      ...prev,
                ...
                <button
                  ...
                  onClick={() => setActiveConfirmPassword((prev) => !prev)}
                >
            ...
            <div className="w-full flex items-center justify-center h-[45px] bg-[#0b57d0] hover:bg-[#0b57b0] active:bg-[#0b57ff] rounded-[5px] mt-2 hover:cursor-pointer">
              <button className="text-[15px] text-white font-semibold">
                {textLogin !== undefined ? 'Xác nhận' : <Loader />}
              </button>
            </div>
            <div className="flex justify-center items-center text-blue-600 text-[14px] mt-2 font-semibold">
              <p>
                Đã có tài khoản chưa?. <Link to="/">Quay lại đăng nhập</Link>
              </p>
            </div>
          </form>
        </div>
